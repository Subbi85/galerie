...
let createImage=(index)=>{
    ...
    newImg.setAttribute('src', 'img/pic'+index+'.jpg')
    if(index <=3 || index >=6){        
...
let initGalerie=()=>{
    ...
    display.style.backgroundImage= "url('img/pic"+slide+".jpg')";
    initMiniPics();
}
...
let switchPic=(index)=>{
    ...
    test.style.backgroundImage= "url('img/pic"+index+".jpg')";
    slide = index;
    buildBorder();
}
